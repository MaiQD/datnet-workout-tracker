...
public interface IEquipmentRepository
{
    ...
    Task<Result<IEnumerable<Equipment>>> GetByUserIdAsync(int userId, CancellationToken cancellationToken = default);
    Task<Result<IEnumerable<Equipment>>> GetGlobalEquipmentAsync(CancellationToken cancellationToken = default);
    Task<Result<IEnumerable<Equipment>>> GetAllForUserAsync(int userId, CancellationToken cancellationToken = default);
    Task<Result<Equipment?>> GetByNameAsync(string name, int? userId = null,
    ...
    Task<Result<bool>> UserOwnsEquipmentAsync(string equipmentId, int userId,
        CancellationToken cancellationToken = default);
}
